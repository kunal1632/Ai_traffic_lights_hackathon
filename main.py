...
def ml_model_timer(flow):
    print("flow",flow)
    flow_percentile = np.array(flow/3).reshape(-1, 1)
    print("flow percenttile",flow_percentile)
    green_time_predict = np.ceil(mj.predict(flow_percentile))
    print("i predicted : ", green_time_predict)
    if green_time_predict < 3:
        green_time_predict = 3
    elif green_time_predict < 5:
        green_time_predict = 5
    elif green_time_predict < 10:
        green_time_predict = 10      
    elif green_time_predict < 15:
        green_time_predict = 15
    elif green_time_predict < 20:
        green_time_predict = 20
...
speeds = {'car':2, 'bus':2, 'truck':2, 'bike':2}
...
signalCoods = [(370, 430), (690, 110), (995, 305), (690, 610)]
signalTimerCoods = [(370, 400), (690, 80), (995, 275), (690, 580)]
...
randomGreenSignalTimerRange = [3, 20]
